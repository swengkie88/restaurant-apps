    ...
    <div class='resto-item'> 
        <div class='card-resto'>    
            <div class='card-img'>
                ...
                <img class="lazyload" alt='${resto.name || '-'}' data-src='${CONFIG.BASE_IMG_URL + resto.pictureId}'/>
            </div>
            <div class='card-body'>
                <h3 class='resto__title'><a href='/#/detail-resto/${resto.id}'>${resto.name || '-'}</a></h3>
...
const createLikeRestoButtonView = () => `
...
const createUnlikeRestoButtonView = () => `
...
export {
  ...
  createLikeRestoButtonView,
  createUnlikeRestoButtonView,
};
